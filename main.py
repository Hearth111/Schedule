...
# =========================================================
# 改良版: フォント一覧/週次オート配置/高精細プレビュー/行間・縁取り修正
#  - フォント: インストール済みフォントから選択（matplotlib があれば高精度）
#  - モード: 単一テロップ / 週次（7つ）を切替、週次は起点日から自動配置
#  - プレビュー: PILで実際に描画→Canvasに貼付（行間/縁取りが見た目通り）
#  - 書き出し: 元解像度へスケール正確変換
#  - 旧機能(複数パターン/ディレクトリ読み込み)は削除済み
# =========================================================
